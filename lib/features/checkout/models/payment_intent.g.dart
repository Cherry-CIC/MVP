...
PaymentIntentData _$PaymentIntentDataFromJson(Map<String, dynamic> json) => PaymentIntentData(
...
Map<String, dynamic> _$PaymentIntentDataToJson(PaymentIntentData instance) => <String, dynamic>{
