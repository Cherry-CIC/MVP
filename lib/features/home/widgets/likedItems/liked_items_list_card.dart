...
class LikedItemListCard extends StatelessWidget { 
  const LikedItemListCard({super.key, required this.product});
            ...
            children: <Widget>[
              ...
              Column(
                children: [
                  ...
                  // third row: price, with the icons (delete, add to cart, like)
                  Container(
                    width: MediaQuery.of(context).size.width * 0.63,
                    padding: EdgeInsets.only(
                      bottom: 0.0,
