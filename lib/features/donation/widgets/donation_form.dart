      ...
      builder: (context, donationViewModel, child) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          if (donationViewModel.status.type == StatusType.success &&
            ...
            final errorMessage = donationViewModel.submissionMessage ??
              ...
              if (showCustomPriceField)
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: (value) {
                      if (showCustomPriceField && (value == null || value.isEmpty)) {
                        return 'Please enter a price';
                      }
                      if (showCustomPriceField && double.tryParse(value!) == null) {
