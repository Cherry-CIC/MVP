...
We recommend checking out some tickets that are great for first contributions: **[Good First Issues](https://github.com/orgs/Cherry-CIC/projects/3/views/1?sliceBy%5BcolumnId%5D=Labels&sliceBy%5Bvalue%5D=good+first+issue)**
