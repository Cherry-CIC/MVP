...
| P0-E2E-03 | Purchased item is removed from public purchase flow | 1. Complete a controlled purchase.<br>2. Return to Home as the buyer or another user.<br>3. Search or scroll for the purchased item.                              | The purchased item is no longer shown as normally purchasable in the public Home/search feed.                                           | Not run |                  |
| P0-E2E-04 | Seller can still trace sold/listed item | 1. Sign in as the seller.<br>2. Open Profile → Listings.<br>3. Review the sold or unavailable item state.                                                           | The item is not hard-deleted unexpectedly. It remains traceable for seller/order/support context with a clear sold, inactive or unavailable state. | Not run |                  |
| P0-E2E-05 | Buyer cannot purchase own listing      | 1. Sign in as a seller with at least one uploaded listing.<br>2. Open Home and search/scroll for that listing.<br>3. Attempt to open or buy the owned listing if reachable. | The seller’s own listing is not available for self-purchase. If reached through stale state, checkout/payment/order creation is blocked. | Not run |                  |
