...
| P0-AUTH-05 | Logout and back navigation | 1. Sign in.<br>2. Visit a product or another secondary screen, then open Settings.<br>3. Select **Log out** and confirm **Sign out**.<br>4. Use the device Back control or back gesture. | Welcome is displayed after successful logout. Back navigation cannot reopen any screen from the previous session. | Not run | [#497](https://github.com/Cherry-CIC/MVP/issues/497) |
| P0-AUTH-06 | Sign in again after logout | 1. Complete P0-AUTH-05.<br>2. Sign in again with email.<br>3. Repeat logout and sign-in using each available social provider. | Successful sign-in opens Home or username setup when required. The app does not remain on Welcome. | Not run | [#497](https://github.com/Cherry-CIC/MVP/issues/497) |
