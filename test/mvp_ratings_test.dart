...
void main() {
  ...
  testWidgets('UserInformationSection shows profile image from photoUrl', (tester) async {
    final authViewModel =
        AuthViewModel(
            loginRepository: _MockLoginRepository(),
            navigator: _MockNavigationProvider(),
          ...
          ..userCredentials = UserCredentials(
            ...
            username: 'Photo User',
            photoUrl: 'https://example.org/profile.jpg',
          );
    ...
    expect((image.image as NetworkImage).url, 'https://example.org/profile.jpg');
  });
}
