...
void main() {
  testWidgets('UserInformationSection shows contact rows while hiding placeholder stats', (
    tester,
  ) async {
  ...
  testWidgets('UserOrderDetails shows profile shortcut tiles for the MVP', (
    tester,
  ) async {
    await tester.pumpWidget(
  ...
  testWidgets('ProfilePage shows profile shortcuts while hiding placeholder profile activity cards', (
    tester,
  ) async {
